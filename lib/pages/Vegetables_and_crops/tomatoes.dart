...
class TomatoesPage extends StatelessWidget {
  const TomatoesPage({Key? key}) : super(key: key);
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              child: BigText(text: "₦250 | Add to cart", color: Colors.white,),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(20),
