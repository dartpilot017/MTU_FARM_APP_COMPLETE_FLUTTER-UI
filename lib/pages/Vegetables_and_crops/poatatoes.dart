...
class PotatoesPage extends StatelessWidget {
  const PotatoesPage({Key? key}) : super(key: key);
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              child: BigText(text: "₦450 | Add to cart", color: Colors.white,),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(20),
